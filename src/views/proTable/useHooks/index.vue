	...
	<div class="table-box">
		<div class="card table-search" v-show="isShowSearch">
			<el-form ref="formRef" :model="searchParam" :inline="true" label-width="100px">
				<el-form-item>
					<el-input v-model="searchParam.username" placeholder="请输入用户姓名" clearable></el-input>
				</el-form-item>
				<el-form-item>
					<el-select v-model="searchParam.gender" placeholder="请选择性别" clearable>
				...
				<el-form-item>
					<el-input v-model="searchParam.email" placeholder="请输入邮箱" clearable></el-input>
				</el-form-item>
